...
set CLASSPATH=.
set CLASSPATH=%CLASSPATH%;%MVN_REPOSITORY%\org\speechforge\cairo\%CAIRO_VERSION%\cairo-%CAIRO_VERSION%.jar
...
set CLASS=org.speechforge.cairo.server.recog.sphinx.SphinxRecEngine$Test
